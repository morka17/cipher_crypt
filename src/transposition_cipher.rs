...
//!
//! The transportation Cipher is a method of encryption by which a message is
//! according to a regular system

/// Encrypts or decrypts a messagge, using multiple keys. The
/// encryption is based on the columnar transportation method.
/// 
...
pub fn transposition(decrypt_mode: bool, msg: &str, key: &str) -> String {
    ...
    for cipher_key in keys.iter() {
        ...
        let mut key_ascii: Vec<(usize, u8)> = cipher_key
            .bytes()
            .enumerate()
...
/// Pergroms the columnar transpositiion encryption
